...
export function AgentsAdminView() {
  ...
  if (viewDetail) {
    return <AgentDetailView onBack={() => setViewDetail(false)} />;
  }
          ...
          <Card className="bg-card border-border">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex gap-2">
                <Button className="flex-1" onClick={() => setViewDetail(true)}>
                  <Settings className="h-4 w-4 mr-2" />
                  编辑配置
                </Button>
                <Button variant="outline" className="flex-1" onClick={() => setViewDetail(true)}>
                  <Play className="h-4 w-4 mr-2" />
                  调试测试
                </Button>
              </div>
