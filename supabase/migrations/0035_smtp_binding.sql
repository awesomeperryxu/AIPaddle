...
--
-- ⚠️ 本文件原编号 0034，因与 X 道的 `0034_extension_identity_and_key_merge.sql`
-- **撞号**而改为 0035（2026-07-31）。两者内容完全不同却同号，谁从零重跑迁移都会
-- 得到错误结果。成因：我在建 0034 前**没查 MIGRATION_PLAN §1 的编号占用登记表**
-- ——而那张表正是我同一天上午为防此事新建的。规矩立了不查，等于没立。
--
